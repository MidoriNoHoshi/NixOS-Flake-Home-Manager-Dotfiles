...
services.dunst = {
    ...
    settings = {
      global = {
        ...
        font = "0xProto Nerd Font 12"; # I kinda want to use Discord Goto font instead.
        line_height = "0";
...
# mouse: follow mouse cursor,
        ...
        progress_bar_height = "2"; # Progress bar height includes the frame. So make sure that it's at least twice as big as the frame width.
        progress_bar_frame_width = "0";
        progress_bar_min_width = "120";
        progress_bar_max_width = "300";
        progress_bar_corner_radius = "120";
